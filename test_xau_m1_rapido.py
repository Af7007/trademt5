#!/usr/bin/env python
"""
Teste Bot XAU MLP - M1 - Operações Rápidas
...
# Configurações específicas para XAU
SYMBOL = "XAUUSDc"
TIMEFRAME = "M1"
# Para XAUUSDc: 1 ponto = 0.001, tick_value = 0.1 (com 1 lote)
# Para $0.50 de lucro com 0.01 lote: precisa de 500 pontos = 0.5 em preço
TP_POINTS = 500  # 500 pontos = 0.5 em preço = ~$0.50 com 0.01 lote
SL_POINTS = 1000  # 1000 pontos = 1.0 em preço = ~$1.00 com 0.01 lote
...
def show_xau_market_data():
    """Mostra dados de mercado do XAU no M1 usando endpoint genérico"""
    separator("DADOS DE MERCADO - XAU/USD M1")
...
def configure_bot():
    """Configura o bot para XAU com parâmetros específicos"""
...
def main():
    ...
    print("\n" + "="*70)
    print("  TESTE BOT XAU MLP - M1 - OPERAÇÕES RÁPIDAS")
    print("  Símbolo: XAUUSD | Timeframe: M1 | TP: $0.50")
    print("="*70 + "\n")
    
    # Passo 1: Mostrar dados de mercado
    show_xau_market_data()
    time.sleep(2)
